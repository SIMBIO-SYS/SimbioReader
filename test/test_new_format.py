...
def test_simbio_reader_init_file_dat():
    file_path = Path(
        "test/data/sim_cal_stc_cruise_ico11_2024-04-08_001/sim_cal_sc_stc_cruise_ico11_2024-04-08_001_winx_internal__0_1.dat"
    )
    reader = SimbioReader(file_path=file_path)
    assert (
        reader.pdsLabel.name == "sim_cal_sc_stc_cruise_ico11_2024-04-08_001__0_1.lblx"
    )


def test_simbio_reader_init_file_lblx():
    file_path = Path(
        "test/data/sim_cal_stc_cruise_ico11_2024-04-08_001/sim_cal_sc_stc_cruise_ico11_2024-04-08_001__0_1.lblx"
    )
    reader = SimbioReader(file_path=file_path)
    assert (
        reader.pdsLabel.name == "sim_cal_sc_stc_cruise_ico11_2024-04-08_001__0_1.lblx"
...
def test_simbio_reader_init_file_lblx_notexist():
    file_path = Path(
        "test/data/sim_cal_stc_cruise_ico11_2024-04-08_002/sim_cal_sc_stc_cruise_ico11_2024-04-08_003__0_1.lblx"
    )
...
def test_simbio_reader_init_folder_multi_lblx():
    ...
    with pytest.raises(
        FileExistsError, match="Multiple .lblx files found in directory"
    ):
        reader = SimbioReader(file_path=file_path)
...
def test_simbio_reader_init_unknown_channel():
    file_path = Path(
        "test/data/sim_cal_stc_cruise_ico11_2024-04-08_002/sim_cal_sc_stc_cruise_ico11_2024-04-08_001__0_1.lblx"
    )
...
def test_simbio_reader_init_lid():
    ...
    assert (
        reader.lid
        == "urn:esa:psa:bc_mpo_simbio-sys:data_calibrated:sim_cal_sc_stc_cruise_ico11_2024-04-08_001"
    )
...
def test_simbio_reader_init_title():
    ...
    assert (
        reader.title
        == "BEPICOLOMBO MPO SIMBIO-SYS MERCURY ORBIT STC CALIBRATED DATA PRODUCT"
    )
...
def test_simbio_reader_init_lvid():
    ...
    assert (
        reader.lvid
        == "urn:esa:psa:bc_mpo_simbio-sys:data_calibrated:sim_cal_sc_stc_cruise_ico11_2024-04-08_001::0.1"
    )
