...
def test_filename():
    old_name = Path(
        "sim_raw_sc_hric_cust0_internal_cruise_cruise_2021-04-24_001__0_1.dat"
    )
    new_name = gen_filename(old_name)
    assert isinstance(new_name, Path)
    assert new_name == Path(
        "sim_browse_raw_sc_hric_cust0_internal_cruise_cruise_2021-04-24_001__0_1"
    )


def test_filename_cal():
    old_name = Path(
        "sim_cal_sc_hric_cust0_internal_cruise_cruise_2021-04-24_001__0_1.dat"
    )
    new_name = gen_filename(old_name)
    assert isinstance(new_name, Path)
    assert new_name == Path(
        "sim_browse_cal_sc_hric_cust0_internal_cruise_cruise_2021-04-24_001__0_1"
    )
...
def test_lvid():
    ...
    assert (
        newLVID
        == "urn:esa:psa:bc_mpo_sim:data_calibrated:sim_cal_sc_hric_cruise_cruise_2021-04-24_001_cust0_internal::0.1"
    )
