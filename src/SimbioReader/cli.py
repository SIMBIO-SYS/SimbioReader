...
@rich_config(
    help_config={
        "header_text": f"SIMBIO-SYS Data Reader, version [blue]{version.short()}[/blue]"
    }
)
...
@click.option(
    "--data-structure", is_flag=True, help="Show the Data Structure", default=False
)
@click.option(
    "--all", "all_info", is_flag=True, help="Show all the information", default=False
)
@click.option(
    "--filters",
    "filter_flag",
    is_flag=True,
    help="Show the filters for the given channel",
    default=False,
)
...
@click.option(
    "-s", "--summarize", is_flag=True, help="Show only the summary", default=False
)
@click.option(
    "--version",
    is_flag=True,
